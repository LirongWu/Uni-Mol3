...
@register_loss("unimol3_tokenizer")
class UniMol3Loss(UnicoreLoss):
    ...
    def forward(self, model, sample, reduce=True):
        ...
        # used for lm head
        masked_tokens = sample[input_key]["src_token"].ne(self.padding_idx)
        ...
        (
            ...
            encoder_distance,
            encoder_coord,
        ) = model(**sample, encoder_masked_tokens=masked_tokens, tokenization=self.args.tokenization)
        target = sample[input_key]["src_token"]
